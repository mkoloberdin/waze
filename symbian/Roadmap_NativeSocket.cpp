...
inline TInt CRoadMapNativeSocket::ConnStart( TConnPref &aConnPrefs )
{
   return ConnAsyncStart( aConnPrefs );
}


TInt CRoadMapNativeSocket::ConnSyncStart( TConnPref &aConnPrefs )
{
   roadmap_log( ROADMAP_ERROR, "Blocking connection is not implemented for sockets" );
