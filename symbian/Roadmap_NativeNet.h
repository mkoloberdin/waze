...
protected: 
  ...
  virtual TInt ConnStart( TConnPref &aConnPrefs ) = 0;	// Connection start. Implementation dependent can be synchronous or asynchronous
  virtual TInt ConnSyncStart(TConnPref &aConnPrefs) = 0;
