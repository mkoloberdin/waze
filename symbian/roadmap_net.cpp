                                         ...
                                         int& retVal)
{
  ...
  if ( protocolType == ESockTypeHttp )
  {
    ...
    TRAPD(err1, s = CRoadMapNativeHTTP::NewL( http_type, name, default_port, flags, update_time, 
                                              callback, context));
                                   ...
                                   roadmap_result* err)
{
  ...
  s = roadmap_net_connect_async_internal(protocol, name, update_time, default_port, flags, NULL, NULL, retVal);
                               ...
                               void *context)
{
  ...
  RoadMapSocket s = roadmap_net_connect_async_internal(protocol, name, update_time,
                                                      default_port, flags, callback, context,
                                                      retVal);
	if ( s == NULL) 
	{
