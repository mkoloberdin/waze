                                 ...
                                 void*       context)
{
    ...
    roadmap_log( ROADMAP_ERROR, "TEMP_AVI 0");
#ifdef IPHONE
    ...
    roadmap_log( ROADMAP_ERROR, "TEMP_AVI 0.1");
...
static void report_dialog(int iAlertType){
   ...
   const char *edit_button_l[] = {"edit_left", "edit_left"};
    ...
    const char *button_tab_icon[]   = {"button_tab_up", "button_tab_down"};
#ifdef EMBEDDED_CE
	isLongScreen = FALSE;
#endif
	if (roadmap_screen_is_hd_screen()){
...
#endif
	 button = ssd_button_label ("Send", roadmap_lang_get ("Send"),
          SSD_WS_TABSTOP|SSD_ALIGN_CENTER, report_menu_buttons_callback);
    ssd_button_change_icon( button, button_tab_icon, 2 );
    ssd_widget_add (group, button );

    button = ssd_button_label ("Hide", roadmap_lang_get ("Hide"),
                         SSD_WS_TABSTOP|SSD_ALIGN_CENTER, report_menu_buttons_callback);
    ssd_button_change_icon( button, button_tab_icon, 2 );
    ssd_widget_add (group, button );

    button = ssd_button_label ("Cancel", roadmap_lang_get ("Cancel"),
                            SSD_WS_TABSTOP|SSD_ALIGN_CENTER, report_menu_buttons_callback);
    ssd_button_change_icon( button, button_tab_icon, 2 );
    ssd_widget_add (group, button );
