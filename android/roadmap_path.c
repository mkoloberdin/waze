 ...
 * LICENSE:
 *
 *   Copyright 2008 Ehud Shabtai, Alex Agranovich
 *
...
static const char *RoadMapPathUserPreferred = "/data/data/com.waze";
...
static const char *RoadMapPathSkinPreferred = "/sdcard/waze/skins";

/* The hardcoded path for configuration files (the "config" path).
 * (Note that the user directory (~/.freemap) does not appear here
...
static const char *RoadMapPathConfigPreferred = "/sdcard/waze";

#ifdef MAPS_STORAGE_SDCARD
	static const char *RoadMapPathMaps[] = {
	   "/sdcard/waze/maps",
	   NULL
	};
	static const char *RoadMapPathMapsPreferred = "/sdcard/waze/maps";
#else
	static const char *RoadMapPathMaps[] = {
	   "/sdcard/waze/maps",
	   NULL
...
#endif //MAPS_STARAGE_SDCARD


static const char *RoadMapPathHome = "/sdcard/waze/";
static const char *RoadMapPathSD = "/sdcard/waze/";
static const char *RoadMapPathGpsSuffix = "gps/";




void roadmap_path_initialize( const char* aCfgPath )
{
...
//
//    if (RoadMapUser == NULL) {
//        RoadMapUser = roadmap_path_cat (roadmap_path_home(), ".freemap");
...
const char *roadmap_path_sdcard (void) {
   static const char *RoadMapPathSD_ = NULL;

   if ( RoadMapPathSD_ == NULL )
   {
	   RoadMapPathSD_ = RoadMapPathSD;
	   roadmap_path_create( RoadMapPathSD_ );
   }
   return RoadMapPathSD_;
}

const char *roadmap_path_config( void )
{
	return RoadMapPathConfigPreferred;
}
...
const char *roadmap_path_gps( void )
{
   ...
   {
	  RoadMapPathGps = roadmap_path_join( roadmap_path_sdcard(), RoadMapPathGpsSuffix );
...
const char *roadmap_path_images( void )
{
   ...
   {
	  RoadMapPathImages = roadmap_path_join( roadmap_path_sdcard(), "images" );
