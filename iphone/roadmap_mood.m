...
void roadmap_mood_dialog (RoadMapCallback callback) {
   ...
   if (roadmap_mood_get_exclusive_moods() < 3) {
   ...
   if (roadmap_mood_get_exclusive_moods() < 2) {
      [dict setValue:[UIColor grayColor] forKey:@"color"];
   } else {
      [dict setValue:[NSNumber numberWithInt:1] forKey:@"selectable"];
   }
   ...
   if (roadmap_mood_get_exclusive_moods() < 1) {
      [dict setValue:[UIColor grayColor] forKey:@"color"];
   } else {
      [dict setValue:[NSNumber numberWithInt:1] forKey:@"selectable"];
   }
   ...
   moodView = [[RoadMapChecklist alloc] 
               ...
               andCallback:roadmap_mood_call_back andHeight:50 andFlags:CHECKLIST_GLOBAL];
}
