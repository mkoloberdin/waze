...
void avoid_trails_show() {
	...
	trailsView = [[RoadMapChecklist alloc] activateWithTitle:text andData:dataArray andHeaders:NULL andCallback:on_avoid_trails_selected];
}
...
void type_show() {
	...
	typeView = [[RoadMapChecklist alloc] activateWithTitle:text andData:dataArray andHeaders:NULL andCallback:on_type_selected];
}
