                                 ...
                                 roadmap_result       rc)
{
   ...
   for( i=0; i< size; i++)
   {
	...
	roadmap_list_menu_generic(roadmap_lang_get(local_search_get_provider_label()), size, results, (void *)indexes, 
							  icons, NULL, NULL, on_list_item_selected, NULL, NULL, on_options, NULL, 90, LIST_MENU_ADD_DETAIL_BUTTON, NULL);
}
...
int on_options(SsdWidget widget, const char *new_value, void *context)	
{
    ...
    */
	...
	roadmap_list_menu_generic("Options", count, labels, (const void**)values, NULL, NULL, NULL, on_option_selected, NULL, NULL, NULL, NULL, 60, 0, NULL);
