/* roadmap_twitter_dialog.h - iPhone twitter settings dialog
 *
 * LICENSE:
 *
...
#ifndef __ROADMAP_TWITTER_DIALOG__H
#define __ROADMAP_TWITTER_DIALOG__H
...
#endif // __ROADMAP_TWITTER_DIALOG__H