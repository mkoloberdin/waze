...
#include "roadmap_twitter_dialog.h"
...
- (void) populateTwitterData
{
   ...
   if (roadmap_twitter_destination_mode() > 0)
   ...
   int tag = [cell tag];
	...
	switch (tag) {
		case ID_TWITTER_SEND_REPORTS:
         ...
         [swCell setState:roadmap_twitter_is_sending_enabled() animated:FALSE];
			break;
      case ID_TWITTER_DESTINATION_ENABLED:
         swCell = (iphoneCellSwitch *) cell;
         [swCell setState:(roadmap_twitter_destination_mode() != ROADMAP_TWITTER_DESTINATION_MODE_DISABLED) animated:FALSE];
			break;
      ...
      case ID_TWITTER_SEND_MUNCHING:
         swCell = (iphoneCellSwitch *) cell;
         [swCell setState:roadmap_twitter_is_munching_enabled() animated:FALSE];
		default:
			break;
	}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
   ...
   */
	...
	switch (tag) {
      case ID_TWITTER_DESTINATION_CITY:
         roadmap_twitter_set_destination_mode(ROADMAP_TWITTER_DESTINATION_MODE_CITY);
         //[tableView reloadRowsAtIndexPaths:indexPaths withRowAnimation:UITableViewRowAnimationNone];
         [tableView reloadData];
         break;
      case ID_TWITTER_DESTINATION_FULL:
         roadmap_twitter_set_destination_mode(ROADMAP_TWITTER_DESTINATION_MODE_FULL);
         //[tableView reloadRowsAtIndexPaths:indexPaths withRowAnimation:UITableViewRowAnimationNone];
         [tableView reloadData];
         break;
	}
	...
	switch (tag) {
      ...
      case ID_TWITTER_DESTINATION_ENABLED:
            ...
            [self showDestination:TRUE];
				...
				roadmap_twitter_set_destination_mode(ROADMAP_TWITTER_DESTINATION_MODE_DISABLED);
